...
class NoiseHead(torch.nn.Module):
    """MLP Regression head for denoising noise."""
    ...
    def loss(
        ...
        target = alternative_target if alternative_target is not None else batch.atom_targets[name]
